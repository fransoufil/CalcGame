...
public class Calcular {
	...
	public Calcular(int dificuldade) {
		...
		if (dificuldade == 1) {
			// facil
			this.valor1 = rand.nextInt(10);// 0 - 9
			this.valor2 = rand.nextInt(10);// 0 - 9
		} else if (dificuldade == 2) {
			// medio
			this.valor1 = rand.nextInt(100);// 0 - 99
			this.valor2 = rand.nextInt(100);// 0 - 99

		} else if (dificuldade == 3) {
			// dificil
			this.valor1 = rand.nextInt(1000);// 0 - 999
